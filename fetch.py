#!/usr/bin/env python3
"""
Recupero codici sconto GNV da shopilo.it
Sursa: https://shopilo.it/negozi/gnv.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/gnv.it"
STORE_NAME = "GNV"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per GNV da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-gnv)"
    }
    try:
